...
def Api_connect():
    api_key = "AIzaSyCosw7zu6NnBMBDfing20ocBFd2IvMc8uM"
...
def get_video_ids(channel_id):
    ...
    while True:
        response1 = youtube.playlistItems().list(
            part = "snippet",playlistId = Playlist_Id,maxResults=50,pageToken=next_page_token).execute()
...
# upload_to_mongodb
client=pymongo.MongoClient("mongodb+srv://arjun07cr:arjun07cr@arjun.nt7lb25.mongodb.net/?retryWrites=true&w=majority&appName=Arjun",tlsCAFile=ca)
...
# Table creation for channels,videos,playlist,comments
...
if question == "1. All the videos and the channel name":
    ...
    query7 = '''select channel_name as channelname,views as totalviews
                from channels'''
    ...
    query10 = '''select title as video_title,channel_name as channelname,comments as comments
